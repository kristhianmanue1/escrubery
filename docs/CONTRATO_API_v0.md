...
- **Anexo de diseño (no servido):** `datos/schemas/conversation-event-v0.schema.json` — contrato vendor-neutral para eventos de conversaciones de CLIs (issue #2, plan `docs/investigacion/Plan_Conversation_Event_v0.md`). No forma parte de la API v0; los probes read-only lo usan como molde. Designado 2026-08-21; se versiona al entrar como operación.
