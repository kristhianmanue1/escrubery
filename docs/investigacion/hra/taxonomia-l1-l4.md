...
**Evidencias web (decreto del Mediador 2026-08-22, MED-4):** para fuentes HTML dinámicas se acepta **cita textual + URL + fecha** sin hash (mismo criterio que `tos-clis.md`); los eventos changelog ya ingeridos vía Evidentia conservan su hash. La regla dura #1 (hash siempre) queda con esta excepción **documentada** para evidencia web no-estable.
