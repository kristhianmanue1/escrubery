...
**Totales H8: 1 ciclo est / 1 real / desviación 0.** Pendiente natural: e2e vivo cuando el Mediador abra la próxima sesión real (opencode dejará `session_created_exec` en el log; claude-code probará inyección real), y la respuesta de ektel a la propuesta de intercambio (relacionada: sus G-gates).
