...
- **En curso:** **Fase 5 — formalización MCP** (implementada: Agent Card firmada, auth X-API-Key + rate-limit 429; adversarial `proceed`, decreto pendiente). Inventario: 9 CLIs, 188 modelos.
